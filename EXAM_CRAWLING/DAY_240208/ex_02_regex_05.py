...
# 전방 긍정 탐색: (문자열이 won을 포항하고 있으면 won 앞의 문자열 리턴
lookahead1 = re.search('.+(?=won)', '1000 won')
if lookahead1 is not None:
    print(lookahead1.group())
else:
    print('None')

# 전방 긍정 탐색: (문자열이 am을 포항하고 있으면 am 앞의 문자열 리턴
...
lookbehind1 = re.search('(?<=므).%', '2023-01-26 am 11:10:01 ')
print(lookbehind1)
